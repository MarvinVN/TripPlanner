        ...
        <div>
            ...
            <div className='App flex h-screen'>
                <div className="w-full max-w-2xl mx-auto mt-10">
                    ...
                    <div>
                        <TripCard 
                            trip={{ trip_id: 1, owner_id: "1", title: 'Trip 1', description: 'Trip 1 description', start_date: '2021-10-01', end_date: '2021-10-10', created_at: '2021-09-01', updated_at: '2021-09-01' }}
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        ...
                        {trips.slice().reverse().map((trip: Trip) => (
                            <div key={trip.trip_id}>
                                <TripCard trip={trip} fetchTrips={fetchTrips}/>
                            </div>
                        ))}
                    </div>
                </div>
